package domain;
// Generated 2018-5-23 17:27:10 by Hibernate Tools 5.2.10.Final
...
public class ParcelHome {
	...
	public Parcel findById(java.lang.Integer id) {
		...
		try {
			Parcel instance = (Parcel) sessionFactory.getCurrentSession().get("domain.Parcel", id);
			if (instance == null) {
	...
	public List findByExample(Parcel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("domain.Parcel")
